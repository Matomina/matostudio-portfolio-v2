    ...
    <div className="dashboard-page">
      <section className="dashboard-hero-card">
        <div>
          ...
          <p>
            Filtrez les prospects, priorisez les relances et preparez la future connexion aux
      ...
      <section className="dashboard-card dashboard-panel">
        ...
        {filteredContacts.length === 0 ? (
          <p className="dashboard-empty-state">Aucun contact ne correspond a ces filtres.</p>
        ) : null}
      </section>
    </div>
  )
